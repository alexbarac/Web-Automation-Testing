...
public class UITesting
 ...
 // String Dir = getoutputPath();
    ...
    public String createDir() {
       ...
       File dir = new File("C:\\IxResources\\InternalResources\\UserInterface\\Connect_TestWeb\\production" + getResultsName(this.getClass().getName()));
        boolean b = dir.mkdir();
    ...
    public void testNow() throws IOException, InterruptedException {
        fstreamGlobal = new FileWriter("C:\\IxResources\\InternalResources\\UserInterface\\Connect_TestWeb\\production\\genericOutput.html");
        ...
        for (UITestSuite testSuite : testSuites)
        {
        	 if (testSuite.isTestSuiteEnabled())
        	{
                ...
                outGlobal.write("<br>");
                outGlobal.newLine();
                fstream = new FileWriter("C:\\IxResources\\InternalResources\\UserInterface\\Connect_TestWeb\\production\\genericOutput" + testSuite.getTestSuiteName() + ".txt");
                out = new BufferedWriter(fstream);

                SuiteResultCounters suiteCounters = UISuiteExcecution.runSuite(reader.getDeviceIp(),reader.getFreq(),
                ...
                outGlobal.write("<br>");
                outGlobal.newLine();
                outGlobal.write("<a href=\"" + suiteCounters.getUrl() + "\">Failed Test Cases Report</a>");
                outGlobal.newLine();
                outGlobal.write("<br>");
                outGlobal.newLine();
                outGlobal.write("<hr color=\"blue\">");
